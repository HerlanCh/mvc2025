                ...
                <div class="card">
                    ...
                    <?php if (isset($_SESSION['user_id'])): ?>
                        <a href="?controller=wishlist&action=add&balon_id=<?php echo $balon["id"]; ?>&redirect=balon"
                            class="btn btn-outline-danger position-absolute top-0 end-1 m-2" style="z-index: 10;"
                    ...
                    <div style="overflow: hidden; height: 250px;">
                        <?php if (!empty($balon["imagen"])): ?>
                            <img src="<?php echo $balon["imagen"]; ?>" class="card-img-top"
                    ...
                    <div class="card-body">
                        ...
                        <?php if ($balon["stock"] > 0): ?>
                            <form action="?controller=carrito&action=agregar" method="POST" class="mb-2"
                                onsubmit="return validarStock(this, <?php echo $balon['stock']; ?>, '<?php echo htmlspecialchars($balon['nombre'], ENT_QUOTES); ?>')">
                                <input type="hidden" name="balon_id" value="<?php echo $balon["id"]; ?>">
                                <div class="input-group input-group-sm mb-2">
                                    <input type="number" name="cantidad" class="form-control" value="1" min="1"
                                        max="<?php echo $balon["stock"]; ?>" required>
